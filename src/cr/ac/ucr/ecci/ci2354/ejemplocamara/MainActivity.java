...
public class MainActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case PHOTO_REQUEST_CODE:
            if (resultCode == RESULT_OK) {
                ...
                if (data != null) {
                    ...
                    Cursor imageCursor = getContentResolver().query(mSelectedImage, columns, null, null, null);
                ...
                int width = photoPreview.getWidth();
                int height = photoPreview.getHeight();
                ...
                Toast.makeText(this, "Photo saved at:" + filename, Toast.LENGTH_SHORT).show();
            } else {
        ...
        case VIDEO_REQUEST_CODE:
            if (resultCode == RESULT_OK) {
                ...
                Log.d("", "Video saved at:" + filename + " uri path:" + videoUri.getPath());
                Toast.makeText(this, "Video saved at:" + filename, Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(this, R.string.photo_error, Toast.LENGTH_SHORT).show();
            }
            break;
    ...
    private void openChooseImageIntent() {
        ...
        captureIntent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(mediaFile));
